...
public class Networks {
    ...
    private Network connectNetwork(final String hostname) {
        ...
        session.addIRCEventListener(new IRCEventAdapter() {
            @Override
                    ...
                    protected IStatus run(IProgressMonitor monitor) {
                        ...
                        if (this.currentSession != null) {
                            ...
                            Collection<IRCEventListener> currentListeners = new ArrayList<>(
                                    this.currentSession.getIRCEventListeners());
                        ...
                        this.currentSession
                                .addIRCEventListener(new IRCEventAdapter() {

                                    @Override
                                    public void onConnectComplete(
                                            ConnectionCompleteEvent e) {
                                        stop();
